...
import { LoaderIcon, BookmarkIcon, Trash2Icon } from 'lucide-react';
...
function createFormData(application: JobApplication): FormData {
    return {
        ...
        interview_date: application.interview_date
            ...
            : '',
        tax_config: application.tax_config
            ? { ...application.tax_config }
            : null,
    };
}
        ...
        <>
            <Dialog open={open} onOpenChange={(open) => !open && onClose()}>
                <DialogContent className="flex max-h-[90vh] flex-col overflow-hidden p-0 sm:max-w-2xl">
                    <DialogHeader className="flex shrink-0 flex-row items-center justify-between px-6 pt-6 pb-2">
